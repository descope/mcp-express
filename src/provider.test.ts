...
describe('DescopeMcpProvider', () => {
    ...
    describe('OAuth endpoints', () => {
        ...
        it('should initialize all required endpoints', () => {
            ...
            expect(endpoints.issuer.toString()).toBe('https://api.descope.com/v1/apps/test-project');
            expect(endpoints.authorization.toString()).toBe('https://api.descope.com/oauth2/v1/apps/authorize');
            expect(endpoints.token.toString()).toBe('https://api.descope.com/oauth2/v1/apps/token');
            expect(endpoints.revocation.toString()).toBe('https://api.descope.com/oauth2/v1/apps/revoke');
        });
    ...
    describe('dynamic client registration options', () => {
        ...
        it('should use custom attribute scopes when provided', () => {
            ...
            const options = provider.options;
            expect(options.dynamicClientRegistrationOptions?.attributeScopes).toEqual(customScopes);
        });
    });
