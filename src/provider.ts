...
export class DescopeMcpProvider {
    ...
    private initializeOptions(opts: Omit<DescopeMcpProviderOptions, 'projectId' | 'managementKey' | 'baseUrl' | 'serverUrl'>): DescopeMcpProviderOptions {
        const dynamicClientRegistrationOptions = {
            attributeScopes: opts.dynamicClientRegistrationOptions?.attributeScopes || DEFAULT_ATTRIBUTE_SCOPES,
